...
const PurchaseConfirmation = () => {
  ...
  const moneyClassName =
    paymentOption === "Dinheiro"
      ? "purchase-confirmation-button button-enabled"
      : "purchase-confirmation-button button-disabled";
  ...
  return (
    <div id="purchaseConfirmation" className="purchase-confirmation-container">
      ...
      <content>
        <div className="purchase-confirmation-title">
        ...
        <div className="purchase-confirmation-buttons">
          ...
          <div className={moneyChangeClassName}>
        ...
        <div className="purchase-confirmation-warning">
          <span>
